            ...
            <div className="relative group cursor-pointer">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-[#7FA2C8] font-medium">
              ...
              <div className="absolute right-0 top-full mt-2 invisible group-hover:visible group-hover:opacity-100 opacity-0 transition-all duration-200 bg-[#5A1E5C] border-2 border-[#7FA2C8] rounded-lg shadow-lg z-50 min-w-48">
                <Link
                  to={user?.esAdmin ? '/mi-perfil-admin' : '/mi-perfil'}
                  className="block px-4 py-3 text-[#7FA2C8] hover:text-white hover:bg-[#6A2A6E] transition-colors rounded-lg whitespace-nowrap"
                >
